...
import type { EstimateSectionConfig } from '@/app/types/estimate-template'
import { ESTIMATE_SECTION_META } from '@/app/types/estimate-template'

export function SectionCard({
  section,
  onChange,
}: {
  section: EstimateSectionConfig
  onChange: (updated: EstimateSectionConfig) => void
}) {
  const [expanded, setExpanded] = useState(false)
  const meta = ESTIMATE_SECTION_META[section.id]
